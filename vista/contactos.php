  ...
  <body id="body-pd">
    ...
    <div class="l-navbar" id="nav-bar">
        ...
        <div> <a href="inicio.php" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">El Quetzal</span> </a>
                ...
                <a href="contactos.php" class="nav_link active"> <i class='bx bx-bookmark nav_icon'></i> <span class="nav_name">Contactos</span> </a>  </div>
...
<h1><strong><em>Nuestro<span>Equipo</span></strong></em></h1>
        ...
        <div class="team_box">
            <div class="profile">
                ...
                <div class="info">
                    <h2 class="name">Jenifer Marin</h2>
            ...
            <div class="profile">
                ...
                <div class="info">
                    <h2 class="name">Junior Medina</h2>
                    <p class="bio">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div class="profile">
                <img src="../img/saira.png">

                <div class="info">
                    <h2 class="name">Saira Guevara</h2>
                    <p class="bio">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div class="profile">
                ...
                <div class="info">
                    <h2 class="name">Diego Penagos</h2>
                    <p class="bio">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div class="profile">
                <img src="../img/mayerli.png">

                <div class="info">
                    <h2 class="name">Mayerli Castañeda</h2>
                    <p class="bio">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
